...
# for examples
# This starts with the default .bashrc from Ubuntu, then modified to best fit, with a new prompt and colorizing from Manjaro
...
if ${use_color}; then
	...
	if [[ ${EUID} == 0 ]]; then
		PS1='\[\033[01;36m\][\h\[\033[00;36m\] \w\[\033[01;36m\]]\n\[\e[00;31m\]`return_code`\[\e[01;00m\]\$\[\033[00m\] '
	else
		PS1='\[\033[01;32m\][\u@\h\[\033[00;32m\] \w\[\033[01;32m\]]\n\[\e[00;31m\]`return_code`\[\e[01;00m\]\$\[\033[00m\] '
	fi
